...
urlpatterns = [
    ...
    path('climate/documents/', RedirectView.as_view(pattern_name='climate', permanent=True)),
    ...
    path('faq.html', RedirectView.as_view(pattern_name='faq', permanent=False)),
    ...
    path('climate-documents.html', RedirectView.as_view(pattern_name='climate', permanent=True)),
